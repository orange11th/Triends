...
.paw-button.liked .text svg {
  --background: var(--heart-background-active); /* 활성 상태의 배경 색상 */
  --border: var(--heart-border-active); /* 활성 상태의 테두리 색상 */
  --shadow-light: var(--heart-shadow-light); /* 활성 상태의 그림자 색상 */
  --shadow-dark: var(--heart-shadow-dark); /* 활성 상태의 어두운 그림자 색상 */
}
